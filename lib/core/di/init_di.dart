...
Future<void> initGetIt() async {
  ...
  sl.registerLazySingleton<PersonDetailDatasource>(() => PersonDetailRemoteDatasourceImpl(sl<DioClient>()));
  sl.registerLazySingleton<PopularPeopleService>(() => PopularPeopleServiceImpl(sl<GetAllPopularUsecase>()));
  sl.registerLazySingleton<PopularPeopleRepository>(() => PopularPeopleRepositoryImpl(sl<PopularPeopleDatasource>() , sl<PopularPeopleDatasource>()));

  sl.registerLazySingleton<PersonDetailRepository>(() => PersonDetailRepositoryImpl(sl<PersonDetailDatasource>()));
  sl.registerLazySingleton(() => PersonDetailRepositoryImpl(sl<PersonDetailDatasource>()));
  sl.registerLazySingleton<PersonDetailService>(() => PersonDetailServiceImpl(sl<GetPersonDetailsUsecase>() , sl<GetPersonImagesUsecase>()));
  sl.registerLazySingleton(() => PersonDetailServiceImpl(sl<GetPersonDetailsUsecase>(),sl<GetPersonImagesUsecase>()));
  ...
  sl.registerLazySingleton<PopularPeopleDatasource>(() => PopularPeopleLocalDatasourceImpl(sl<CacheHelper>()));
  sl.registerLazySingleton<PopularPeopleDatasource>(() => PopularPeopleRemoteDatasourceImpl(sl<DioClient>()));

  sl.registerLazySingleton(() => PopularPeopleRepositoryImpl(sl<PopularPeopleDatasource>() , sl<PopularPeopleDatasource>()));

  sl.registerFactory(() => GetAllPopularUsecase(sl()));

  sl.registerLazySingleton(() => PopularPeopleServiceImpl(sl<GetAllPopularUsecase>()));
